...
test("homepage keeps its audit fixes", () => {
  ...
  assert.equal((html.match(new RegExp(`<a href="${calendarUrl}" target="_blank" rel="noopener noreferrer" aria-label="Try a Demo \\(opens in a new tab\\)" class="btn btn-primary(?: btn-lg)?">Try a Demo<\\/a>`, "g")) ?? []).length, 3);
